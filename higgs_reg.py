...
def plot_decision_boundary(func, X, y, figsize=(9, 6)):
    ...
    hticks = 3*np.linspace(amin, amax, 101)
    vticks = 3*np.linspace(bmin, bmax, 101)
    ...
    contour = plt.contourf(aa, bb, cc, cmap=cm, alpha=0.6)
    ...
    plt.xlim(amin*3, amax*3)
    plt.ylim(bmin*3, bmax*3)
...
plot_decision_boundary(lambda X_train: model.predict(X_train), X_test, Y_test)
